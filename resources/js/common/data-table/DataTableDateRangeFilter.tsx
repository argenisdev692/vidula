    ...
    <div className={`flex items-center gap-3 ${className}`}>
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="h-9 rounded-lg border border-(--border-default) bg-(--bg-card) px-3 text-sm text-(--text-primary) shadow-sm transition-all focus:border-(--blue-500) focus:outline-none focus:ring-1 focus:ring-(--blue-500)"
        />
      </div>
      <div className="flex flex-col gap-1.5">
        <label className="text-[10px] font-bold uppercase tracking-wider text-(--text-disabled)">
