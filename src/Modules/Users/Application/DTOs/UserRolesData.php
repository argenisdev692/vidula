 ...
 * empty array revokes every role). Names are validated against the live,
 * non-suspended catalogue so a client can never attach an unknown/mismatched role.
 * Direct permission top-ups live on a separate, dedicated screen.
 */
