...
// ── Inertia Pages ──
Route::get('/', function () {
    return Inertia::render('clients/ClientIndexPage');
})->name('client.index');

Route::get('/create', function () {
    return Inertia::render('clients/ClientCreatePage');
})->name('client.create');

Route::get('/{uuid}', function (string $uuid) {
    return Inertia::render('clients/ClientShowPage', ['clientId' => $uuid]);
})->name('client.show')->whereUuid('uuid');

Route::get('/{uuid}/edit', function (string $uuid) {
    return Inertia::render('clients/ClientEditPage', ['clientId' => $uuid]);
