 ...
 * quality-loop Job in Infrastructure) decides whether to iterate again or
 * persist the result. Exactly ONE attempt per call — the up-to-5-iteration
 * loop is orchestrated by that Job, not here; keeping the loop out of the
 * port/adapter is what lets the adapter stay a thin, swappable AI client.
 *
