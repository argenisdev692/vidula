...
/**
 * Shared list filter — consumed by ListPortfoliosHandler via the single
 * `PortfolioEloquentModel::scopeApplyFilters()` (BACKEND-PHP §4.1 — no
...
final class PortfolioFilterData extends SoftDeleteFilterData
{
    /**
